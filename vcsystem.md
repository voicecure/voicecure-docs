...
그 소리는 인두, 구강, 비강 등 성도(Vocal tract)를 지나며 음색이 변합니다.  
이 과정을 소스–필터 이론(Source–Filter Theory)이라고 합니다.

성도는 공명기처럼 작용하여, 성대에서 나온 소리 중 일부 주파수를 강조하고  
다른 주파수는 약화시킵니다. 이렇게 조절된 결과를 포만트(Formant)라고 합니다.  
이 덕분에 우리는 서로 다른 모음을 구분할 수 있습니다.

이 모델은 음성학의 기초 개념으로,  
소리가 만들어지는 기본 구조를 설명할 때 유용합니다.

하지만 보컬 트레이닝에서는  
단순히 소리의 생성 구조를 이해하는 것만으로는 부족합니다.  
성도는 음향을 조절하는 통로일 뿐 아니라,  
...
성도(인두, 구강, 비강)는 단순히 소리의 통로가 아니라,  
성대의 움직임에도 직접적인 영향을 주는 조절 요소입니다.  
따라서 소리의 밝기, 명료도, 조음 방식 조절은 단순한 음색 조절을 넘어,  
호흡과 성대 기능에도 영향을 미치는 중요한 과정입니다.
