...
보이스큐어의 워크플로우는 단순한 연습 순서가 아닌,  
학습자의 발성 경향과 문제점을 기준으로 기능별 조절 능력을 점진적으로 확장해가는 연습 로드맵입니다.  
각 단계는 호흡, 성대, 성도의 기능을 중심으로 구성되어,  
한 기능에만 집중하는 것이 아니라 상호작용을 고려해 최종적으로 통합적으로 훈련되도록 설계되어 있습니다.  

## <span style="color:#f4c66c">2-2. 왜 기능별로 나누어 연습하나요?</span>

실제 발성에서는 모든 기능이 동시에 작동하지만,  
학습자 입장에서는 현재 자신의 습관이나 보상 경향을 분리해서 인식하는 것이 어렵습니다.  
그래서 기능별로 나누어 훈련하면 불필요한 보상 없이  
지금 부족한 조절 능력에 집중할 수 있으며,  
결국엔 모든 기능이 통합된 상태로 자동화되도록 만드는 데 도움이 됩니다.  
